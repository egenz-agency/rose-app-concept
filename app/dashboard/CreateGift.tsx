...
export function CreateGift({ email }: { email: string }) {
  ...
  return (
    <div className="ui-surface" style={{ height: "100dvh", overflowY: "auto", WebkitOverflowScrolling: "touch", background: "#0a0205", padding: "48px 24px", display: "flex", justifyContent: "center" }}>
      <div style={{ width: "100%", maxWidth: 460 }}>
        <p style={{ color: "rgba(242,236,224,0.45)", fontSize: 12 }}>{email}</p>
        <h1 style={{ fontSize: 32, color: "#f2ece0", margin: "4px 0 6px" }}>
          Create your gift
        </h1>
        <p style={{ color: "rgba(242,236,224,0.55)", fontSize: 14, marginBottom: 26 }}>
...
const labelStyle: React.CSSProperties = { display: "flex", flexDirection: "column", gap: 6, color: "rgba(242,236,224,0.8)", fontSize: 13 }
...
const buttonStyle = (busy: boolean): React.CSSProperties => ({ marginTop: 8, padding: "13px 16px", borderRadius: 999, border: "1px solid rgba(184,148,74,0.3)", background: "linear-gradient(135deg, rgba(138,21,40,0.92), rgba(100,12,28,0.95))", color: "#f2ece0", fontSize: 15, cursor: "pointer", opacity: busy ? 0.6 : 1 })
